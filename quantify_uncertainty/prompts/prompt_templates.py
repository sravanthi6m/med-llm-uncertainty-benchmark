shared_zero_prompt = """The following is a multiple-choice question with five potential answers. Only one of these options is correct. Please make your best effort and select the correct answer. You only need to output the option.\n\n"""
